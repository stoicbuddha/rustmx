 ...
 * @param {string} value
 */
export function store_string(key, value) {
    try {
        ...
        wasm.store_string(retptr, ptr0, len0, ptr1, len1);
 ...
 */
export function retrieve_string(key) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        wasm.retrieve_string(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
 ...
 */
export function handle_request(path, method, query_params) {
    const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(method, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(query_params, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.handle_request(ptr0, len0, ptr1, len1, ptr2, len2);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_68d2d1a0cc635a57 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rustmx_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
